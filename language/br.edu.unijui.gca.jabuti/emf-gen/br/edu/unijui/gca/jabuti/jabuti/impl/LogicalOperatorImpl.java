 ...
 * </p>
 * <ul>
 *   <li>{@link br.edu.unijui.gca.jabuti.jabuti.impl.LogicalOperatorImpl#getSymbol <em>Symbol</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LogicalOperatorImpl extends MinimalEObjectImpl.Container implements LogicalOperator
{
	...
	public void setSymbol(String newSymbol)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, JabutiPackage.LOGICAL_OPERATOR__SYMBOL, oldSymbol, symbol));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case JabutiPackage.LOGICAL_OPERATOR__SYMBOL:
				return getSymbol();
		}
